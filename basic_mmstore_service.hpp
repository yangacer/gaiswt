...
#define DEF_INDIRECT_CALL_0_CONST(R, N) \
  R N(implementation_type &impl) const { return impl->N(); }

#define DEF_INDIRECT_CALL_1_CONST(R, N, T0) \
  R N(implementation_type &impl, T0 arg0) const { return impl->N(arg0); }

#define DEF_INDIRECT_CALL_2_CONST(R, N, T0, T1) \
  R N(implementation_type &impl, T0 arg0, T1, arg1) const { return impl->N(arg0,arg1); }
  ...
  DEF_INDIRECT_CALL_1_CONST(boost::int64_t, get_currnet_size, std::string const&);
